"""
Production settings for DRF SRC project.
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['altonode.com', ])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='DRF SRC <noreply@altonode.com>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[DRF SRC]')
